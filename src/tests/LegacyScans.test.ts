...
import { LegacyScans } from '../LegacyScans/LegacyScans'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('LegacyScans Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new LegacyScans(cheerio)
     ...
     */
    const mangaId = 'level-up-from-max-level'

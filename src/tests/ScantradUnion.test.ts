...
import { ScantradUnion } from '../ScantradUnion/ScantradUnion'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ScantradUnion Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new ScantradUnion(cheerio)
     ...
     */
    const mangaId = 'bai-lian-cheng-shen'

...
import { MangasOrigines } from '../MangasOrigines/MangasOrigines';

describe('MangasOrigines Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: Source = new MangasOrigines(cheerio);
     ...
     */
    var mangaId = "martial-arts-reigns";  

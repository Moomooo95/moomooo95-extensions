...
import { PerfScantrad } from '../PerfScantrad/PerfScantrad'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('PerfScantrad Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new PerfScantrad(cheerio)
     ...
     */
    const mangaId = 'the-strongest-manager-in-history'
